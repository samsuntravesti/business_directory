...
<section>
			<div class="row">
				<div class="col-md-5"><a href="/search.php" id="logopic"><img src="<?php SITE_URL ?>/logo1.png" id="logoId"> </a></div>
					<div class="col-md-7">
						<form action="<?php echo  SITE_URL . '/search.php' ?>" method="get">
							<div class="input-group">
	     						 ...
	     						 <span class="input-group-btn">
      								  <button class="btn btn-default" type="submit" onclick="search();"><span class="glyphicon glyphicon-search" aria-hidden="true"></span>.</button>
     							 </span>
	  					    </div>
  					   	<!-- </form>  -->
