...
<section id="edit">
			...
			<div class="row">
			<?php
				if($_GET['upd_company'] == 'Ավելացնել'){
					if($_GET['hvhh']==$organization['number']){
						echo "<script type='text/javascript'>alert('Այս ՀՎՀՀ արդեն գոյություն ունի։');</script>";
			...
			?>
				...
				<div class="col-md-8 registrForm">
					...
					<!-- <form class="form-horizontal" action="" method="get" id="formId"> -->
						<div class="form-group">
						    <label for="number" class="col-md-6 control-label">ՀՎՀՀ*</label>
							    <div class="col-md-6">
							      <input type="text" class="form-control" pattern="^[ 0-9]{8}" id="inputId" name="hvhh"  onkeypress="if(isNaN( String.fromCharCode(event.keyCode) )) return false;"  value="<?php echo $organization['number']; ?>" required>
							    </div>
						</div>
 						<div class="form-group">
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
						   		 <label for="inputDir" class="col-md-6 control-label">Ղեկավար*</label>
							   		 <div class="col-md-6">
							     		 <input type="text" class="form-control" id="inputDir"  name="inputDir" value="<?php echo $organization['president']; ?>" pattern="^[a-zA-Z]+$" required>
							   		 </div>
						 	 </div>
